...
let create_pass_manager the_execution_engine =
  ...
  Llvm_target.DataLayout.add (Llvm_executionengine.ExecutionEngine.target_data the_execution_engine) the_pm; (* LLVM version 3.2 *)
(*  Llvm_target.DataLayout.add_to_pass_manager the_pm (Llvm_executionengine.ExecutionEngine.data_layout the_execution_engine); (* LLVM version 3.5 *) *)
